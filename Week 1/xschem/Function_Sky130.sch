...
N 280 -900 280 -870 {
lab=VDD}
C {devices/vsource.sym} -300 -610 0 0 {name=Vdd value=1.8}
C {devices/gnd.sym} -300 -580 0 0 {name=l1 lab=GND}
C {devices/vdd.sym} -300 -640 0 0 {name=l2 lab=VDD}
C {devices/vsource.sym} -300 -460 0 0 {name=Vdd1 value="pulse(0 1.8 0.1n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -300 -430 0 0 {name=l5 lab=GND}
C {devices/ipin.sym} -300 -490 0 0 {name=p1 lab=A
}
C {devices/vsource.sym} -300 -350 0 0 {name=Vdd2 value="pulse(0 1.8 0.2n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -300 -320 0 0 {name=l6 lab=GND}
C {devices/ipin.sym} -300 -380 0 0 {name=p3 lab=B
}
C {devices/vsource.sym} -530 -460 0 0 {name=Vdd3 value="pulse(0 1.8 0.3n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -530 -430 0 0 {name=l7 lab=GND}
C {devices/ipin.sym} -530 -490 0 0 {name=p5 lab=C
}
C {devices/vsource.sym} -530 -350 0 0 {name=Vdd4 value="pulse(0 1.8 0.4n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -530 -320 0 0 {name=l8 lab=GND}
C {devices/ipin.sym} -530 -380 0 0 {name=p6 lab=D
}
C {devices/vsource.sym} -760 -450 0 0 {name=Vdd5 value="pulse(0 1.8 0.5n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -760 -420 0 0 {name=l3 lab=GND}
C {devices/ipin.sym} -760 -480 0 0 {name=p7 lab=E
}
C {devices/vsource.sym} -760 -340 0 0 {name=Vdd6 value="pulse(0 1.8 0.6n 10p 10p 1n 2n)"}
C {devices/gnd.sym} -760 -310 0 0 {name=l9 lab=GND}
C {devices/ipin.sym} -760 -370 0 0 {name=p8 lab=F
}
C {devices/code_shown.sym} 670 -800 0 0 {name=SPICE only_toplevel=true 
value="
...
C {devices/gnd.sym} 320 -70 0 0 {name=l4 lab=GND}
