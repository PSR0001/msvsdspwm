...
parser = argparse.ArgumentParser(description="Week 4 TASK")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "week4":
    print('Error: Generator specification must be "week4".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_week4"
