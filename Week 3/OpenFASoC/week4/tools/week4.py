...
with open(srcDir + "/TTF.v", "r") as file:
    filedata = file.read()
if args.mode == "verilog":
    with open(flowDir+ "design/src/week4/TTF.v", "w") as file:
        file.write(filedata)
     
print("# Week 4 TASK - Verilog Generated")
print("#----------------------------------------------------------------------")
